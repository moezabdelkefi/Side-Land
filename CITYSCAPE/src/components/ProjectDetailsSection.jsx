          ...
          <div className="row gy-4">
            <div className="col-lg-8">
              ...
              <div className="project-details__content">
                ...
                <p className="project-details__desc font-18">
                  {location.state.desc.slice(0, 250)}
                </p>
                <p className="project-details__desc font-18">
                  {location.state.desc.slice(251, 900)}
                </p>
                ...
                <p className="project-details__desc font-18">
                  ...
                  lobortis viverra laoreet augue mattis ferment ullamcorer
                  viverra laoreet Aliquam eros justo, posuere loborti viverra
                  laoreet matti ullamcorper ere viverra .Aliquam eros justo,
                  posuere lobortis non, viverra Aliquam eros justo, posuere
                ...
                <ul className="text-list-two">
                  {challengeLists.map((challengeList, challengeListIndex) => {
                    return (
                      <li
                        className="text-list-two__item font-18"
                        key={challengeListIndex}
                      >
                        {challengeList.text}
                      </li>
                    );
            ...
            <div className="col-lg-4">
              <div className="project-sidebar__box mt-0">
                <ul className="project-sidebar">
                  {projectSidebarLists.map(
                    (projectSidebarList, projectSidebarListIndex) => {
                      return (
                        <li
                          className="project-sidebar__item"
                          key={projectSidebarListIndex}
                        >
                ...
                <ul className="social-share-list style-two mt-lg-5 mt-4">
                  {socialLists.map((socialList, socialListIndex) => {
                    return (
                      <li
                        className="social-share-list__item"
                        key={socialListIndex}
                      >
                        <Link
                          to={socialList.link}
                          className="social-share-list__link"
                        >
                          {socialList.icon}
                        </Link>
                      </li>
