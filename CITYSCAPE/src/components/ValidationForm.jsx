            ...
            <form action="#" onSubmit={formik.handleSubmit}>
                <div className="row gy-30">
                    ...
                    <div className="col-lg-12">
                        ...
                        <div className="position-relative">
                            <textarea 
                                placeholder="Hello, I'm interested in listing my property with Grow And More Real Estate. I have [number of units] in [area] available for [rent/sale]. Please reach out to discuss my specific requirements. Thank you. "
                                name='message'
                                id='message'
                                onChange={formik.handleChange}
                                onBlur={formik.handleBlur}
