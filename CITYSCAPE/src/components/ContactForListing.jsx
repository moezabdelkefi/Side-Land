                    ...
                    <div className="contact-form bg-white">  
                        <div className="section-heading">
                            <span className="section-heading__subtitle bg-gray-100"> 
                                <span className="text-gradient fw-semibold">Contact For Listing</span> 
                            </span>
                            <h2 className="section-heading__title">Ready to list your property?</h2>
                            <p className="section-heading__desc">Contact us today to showcase your property to the right audience with expert guidance and personalized support. Let’s turn your listing into success!</p>
                        </div>
...
export default ContactForListing;